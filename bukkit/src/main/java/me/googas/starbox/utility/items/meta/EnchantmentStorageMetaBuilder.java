...
public class EnchantmentStorageMetaBuilder extends ItemMetaBuilder {
  ...
  @NonNull @Getter private final Map<Enchantment, Integer> storage = new HashMap<>();
  ...
  @Override
  public @NonNull EnchantmentStorageMetaBuilder addEnchantment(
  ...
  public EnchantmentStorageMeta build(@NonNull ItemStack stack) {
    ...
    if (itemMeta instanceof EnchantmentStorageMeta) {
      ...
      storage.forEach(
          ((enchantment, level) -> storageMeta.addStoredEnchant(enchantment, level, true)));
      return storageMeta;
    }
    return null;
  }
