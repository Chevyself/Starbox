...
/**
 * Represents a {@link Language} file to have as a resource and get objects based on a desired
 * language. Even if utilities such as the {@link java.util.ResourceBundle} exists, this class is
 * something more appropriate for the scope of Starbox.
 */
public interface Language {
  ...
  /**
   * Get a raw object for the provided key. A raw object can be null but it must be handled by the
   * get methods.
   *
